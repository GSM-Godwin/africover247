...
export function WizardStepper({ steps, currentStep }: WizardStepperProps) {
  return (
    <div className="mb-10 overflow-x-auto">
      <div
        className="flex items-start min-w-[480px] max-w-3xl mx-auto px-2"
        style={{ minWidth: `${steps.length * 140}px` }}
      >
          ...
          return (
            <div key={step.num} className="flex items-start flex-1 last:flex-none">
              <div className="flex flex-col items-center">
                <div
                  className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 text-sm font-body font-semibold ${
                    isCompleted
                ...
                <p
                  className={`mt-3 text-xs sm:text-sm font-body text-center w-24 sm:w-28 leading-snug ${
                    isCurrent
